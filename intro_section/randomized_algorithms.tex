...
\begin{enumerate}
  ...
  \item Randomized MinCut (Karger’s Algorithm)
  \item Randomized Color-coding for detecting length-$k$ Cycle
  \item Randomized MST (Karger–Klein–Tarjan)
  \item Randomized Matrix Multiplication (sampling)
  \item Randomized SVD (low-rank)
  \item Factorized Multiplication via low-rank factors
  \item Quantum Integration Engine
\end{enumerate}
