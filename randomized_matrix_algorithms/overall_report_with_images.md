...
![RMM error vs sampling ratio by matrix type](rmm/results/figures/fig1_error_vs_ratio_by_matrix_type.png)
...
**Sparsity Sensitivity** (fixed sampling ratios):

![RMM error vs sampling ratio by sparsity](rmm/results/figures/fig3_error_vs_ratio_by_sparsity.png)

Sparse matrices (1-10% density) follow the same √s error decay, with slightly higher variance at extreme sparsity because few columns dominate the mass.
...
![RMM runtime scaling vs matrix size](rmm/results/figures/fig4_runtime_vs_size.png)
...
![RSVD error vs target rank across matrix types](rsvd/results/figures/rsvd_fig1_error_vs_rank.png)
...
![RSVD runtime scaling vs matrix size](rsvd/results/figures/rsvd_fig3_runtime_vs_size.png)
...
**Error-runtime tradeoff across workloads**:

![RSVD error vs runtime tradeoff](rsvd/results/figures/rsvd_fig4_error_vs_runtime.png)
...
**Intrinsic rank sensitivity**:

![LR-GEMM error vs intrinsic rank](low_rank_gemm/results/figures/fig4_error_vs_intrinsic_rank.png)
...
**Online speedup vs target rank**:

![LR-GEMM online speedup vs target rank](low_rank_gemm/results/figures/fig2_speedup_vs_rank.png)
...
![LR-GEMM runtime vs matrix size (offline + online)](low_rank_gemm/results/figures/fig6_runtime_vs_size.png)
...
![Overall method comparison by workload](overall/results/figures/method_comparison_by_workload.png)

![Speedup heatmap across methods and workloads](overall/results/figures/method_workload_heatmap.png)
...
![Scaling of runtime and speedup with matrix size](overall/results/figures/scaling_with_size.png)

![Speedup scatter across all methods](overall/results/figures/speedup_scatter_all_methods.png)
